                ...
                if (order_arr[c] >= 1 && order_arr[c] <= 15){           /* IF PRODUCT NO. IS VALID, THEN ASK FOR QUANTITY */
                   quantity:
                    ...
                    if (quan[c] >= 1 && quan[c] <= 10){
                        if (cust_type == 1){
                            filedorder << " " << order_arr[c] << " " << quan[c];       /* IF QUANTITY IS IN THE RANGE, THEN STORE DINE IN ORDER INTO D_ORDER.TXT*/
                        }else if (cust_type == 2){
                            filetorder << "  " << order_arr[c] << " " << quan[c];      /* IF QUANTITY IS IN THE RANGE,, THEN STORE TAKE AWAY ORDER INTO T_ORDER.TXT*/
                        }
                        c++;                                                           /* ORDER +1 */
